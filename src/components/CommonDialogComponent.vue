<template>
  ...
  >
    ...
    <!-- 新增議題 -->
    <!-- ExchangeIndicatorsContent.vue -->
    <div id="dialog-block" class="addIssue" v-if="props.dailogType == 'addIssue'">
      <div id="dialog-content">
        <div id="dialog-title">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="48" height="48" rx="24" fill="#F5FDF9"/>
        ...
        <div style="margin-bottom: 12px;">議題代號 : 1</div>
        <label for="text-length">
          <p class="label-title">
            議題名稱
          </p>
          <div class="input-group">
            <input type="text" id="text-length" v-model="newIssueName" placeholder="請填寫">
          </div>
        </label>
      </div>
      <div id="dialog-footer">
    ...
    <!-- 新增指標 -->
    <!-- ExchangeIndicatorsContent.vue -->
    <div id="dialog-block" class="addIssueList" v-if="props.dailogType == 'addIssueList'">
      <div id="dialog-content">
        <div id="dialog-title">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="48" height="48" rx="24" fill="#F5FDF9"/>
...
const addNewIssue = function(){
  emits('addNewIssue', newIssueName.value);
};
